/**
  ******************************************************************************
  * @file    Mems_DIP24_Eval-Board/i2c.c 
...
/**
  * @brief  I2C1_Init This function configures and initializes  I²C1 module with the standard 100kbps bitrate.
  * @param  None
  * @retval None
  */
void I2C1_Init(void){
...
/**
  * @brief  I2C2_Init This function configures and initializes  I²C2 module with the standard 100kbps bitrate.
  * @param  None
  * @retval None
  */
void I2C2_Init(void){
...
/**
  * @brief  I2C2_Init_Advanced This function configures and initializes I²C2 module using custom bitrate setting. 
  *  As per the I²C standard, SCL clock may be 100 kHz or 400 kHz. (NOT IMPLEMENTED)
  * @param  None
  * @retval None
  */
...
/**
  * @brief  I2C2_Disable Disable I2C2
  * @param  None
  * @retval None
  */
...
/**
  * @brief  I2C2_Master_Slave_Addr_Set Sets the address that the I²C2 Master will place on the bus, i.e. Slave address.
  * @param  Slave address and read or write to set CR2 bit10
  * @retval None
  */
...
/**
  * @brief  I2C2_Master_Bus_Busy is I2C2 bus busy?
  * @param  None
  * @retval 0 Not busy
  */
...
/**
  * @brief  I2C2_Master_Busy is I2C2 master busy?
  * @param  None
  * @retval 0 Not busy
  */
...
/**
  * @brief  I2C2_Read Receives a byte from the I²C2 bus.
  * @param  pointer for data emplacement, receiption mode 
  * @retval 0 OK -  0xFF KO
  */
...
/**
  * @brief  I2C2_Write Sends data byte via the I²C2 bus.
  * @param  data to send, write mode type
  * @retval 0 OK -  0xFF KO
  */
...
/**
  * @brief  I2C2_ReadNBytesFromAddr Read nb bytes from I2C2
  * @param  pointer for data emplacement, nb of bytes to read, address read start, slae address when read, slave address for write
  * @retval 0 OK -  0xFF KO
  */
